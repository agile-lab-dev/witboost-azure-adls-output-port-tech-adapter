package it.agilelab.witboost.provisioning.adlsop.principalsmapping.azure;
...
@SpringBootTest(classes = AzureMapperTest.class)
class AzureMapperTest {
    ...
    @BeforeEach
    void setUp() {
        client = Mockito.mock(AzureClient.class);
